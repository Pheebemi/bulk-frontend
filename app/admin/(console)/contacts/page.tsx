...
export default function AdminContactsPage() {
  const { groups, uploadCsv, createGroup, addContact, fetchGroupContacts } = useAdminStore();
    ...
    <div>
      <div className="mb-2">
        ...
        <p className="mt-1 text-sm text-muted">
          The admin console&apos;s own groups — separate from any customer&apos;s. Use these to send a platform
          campaign to a specific list instead of every user (see Send campaign).
        </p>
      </div>
